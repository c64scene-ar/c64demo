...
INSTRUCTIONS = {
    ...
    M65_asl : TimedInstruction(None, None, None, None, None, None, None, None, None, None, None, None),   #  C <- A7, A <- (A) << 1
...
class MOS6502Timming(object):
    ...
    def __get_inst_time(self, address):
        ...
        if op.type == o_void:
            ...
            if self.zero_page_idx_ind_x_re.match(str_op):
        ...
        #print "%02d - type:%s value:%s" % (operand_index, _type, value)
