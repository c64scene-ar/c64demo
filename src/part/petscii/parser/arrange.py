...
print "idiv25timeswdiv40:" 
for j in range(16):
  print "  .byt " + ",".join(str((i/25)*(w/40)) for i in range (j*16, j*16+16))
...
print "imod25:"
for j in range(32):
  print "  .byt " + ",".join(str(i % 25) for i in range (j*16, j*16+16))
